...
<div class="g_12">
    <div class="widget_header">
        ...
        <span class="label right">
            <asp:CheckBox ID="chckGelecekFilm" runat="server" title="Gelecek Film"/>
        </span>
    ...
    <div class="widget_contents noPadding">
	    <div class="line_grid">
		    ...
		    <div class="g_9">
                <asp:TextBox ID="txtFilmBasligi" CssClass="simple_field" runat="server" AutoPostBack="True" OnTextChanged="txtFilmBasligi_TextChanged"></asp:TextBox>
		    </div>
	    </div>
        <div class="line_grid">
